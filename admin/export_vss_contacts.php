...
if (isset($_POST['export_csv_contacts'])) { 
...
$output = "";
$sql = mysqli_query($con_signin,"select id, con_name, con_email, created_by, created_on from visitor_contacts");
...
$filename = "contacts_export-$add_rand.csv";
...
//Report to Logs
$sql_log_report = "insert into logs values(LAST_INSERT_ID(), 'Contacts CSV Export Requested', '$set_usr', '$fptime', '$log_ip', '0')";
